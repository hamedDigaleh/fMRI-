function [specificity, precision, accuracy, error, sensitivity]=PerformKNN(max_num_ICs ,max_num_selected_peaks,NumNH,histogram )
tic
...
%     species = svmclassify(svmStruct,ind(1,1:size(ind,2)));
    mdl=fitcknn(Datas_mod , Classes_mod,'NumNeighbors',NumNH,'Standardize',1);
